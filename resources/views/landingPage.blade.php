...
<head>
    ...
    <title>Tracking-D - Kelola Diabetes</title>
...
<body>
    ...
    <header class="header">
        ...
        <button class="header__tombol-masuk">Masuk/Daftar</button>
    </header>

    <section class="bagian-hero">
        <div class="hero__konten">
            <h1 class="hero__judul">Kelola Diabetes Lebih Mudah, Cepat, dan Terarah dengan <span class="hero__judul-highlight">Tracking-D</span></h1>
            ...
            <button class="hero__tombol-utama">Mulai Sekarang</button>
        </div>
    ...
    <section class="bagian-penjelasan">
        <div class="penjelasan__gambar">
            <img src="{{ asset('images/doctor2.png') }}" alt="logo2">
            </div>
        <div class="penjelasan__konten">
            <h2 class="penjelasan__judul">Mengapa Sistem Manajemen Diabetes Dibutuhkan?</h2>
            <p class="penjelasan__deskripsi">Pendekatan terpadu untuk pasien diabetes menuntut fasilitas kesehatan untuk memiliki sistem yang cepat, akurat, dan terintegrasi. Dengan Tracking-D, kualitas layanan meningkat, dan penanganan pasien merasakan ketika dokter menggunakan teknologi AI.</p>
        </div>
    </section>

    <section class="bagian-fitur">
        <h2 class="fitur__judul">Fitur</h2>
        <p class="fitur__subjudul">Lorem ipsum is simply dummy text of the printing and typesetting industry.</p>
    ...
    <section class="bagian-tutorial">
        <h2 class="tutorial__judul">Tutorial</h2>
        <p class="tutorial__subjudul">Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
...
<footer class="kaki-halaman">
    <div class="kaki-halaman__wadah">
        <div class="kaki-halaman__kolom">
            <h4 class="kaki-halaman__judul-kolom">Tracking-D</h4>
        ...
        <div class="kaki-halaman__kolom">
            ...
            <p class="kaki-halaman__teks"><i class="fas fa-map-marker-alt"></i> Jl. Sehat No. 1, Jakarta</p>
            <p class="kaki-halaman__teks"><i class="fas fa-envelope"></i> info@trackingd.com</p>
            <p class="kaki-halaman__teks"><i class="fas fa-phone"></i> +62 812-3456-7890</p>
        </div>
    </div>
    <div class="kaki-halaman__hak-cipta">
        &copy; 2024 Tracking-D. Semua Hak Dilindungi.
    </div>
</footer>
</html>