...
<html lang="id">
    ...
    <body>
        <header class="header">
            ...
            </nav><div class="header__profil-user">
            ...
            <main class="bagian-fitur-utama">
                ...
                <div class="wadah-prediksi">
                    <!-- Kolom Input Formulir: Menggunakan kelas container yang sudah diatur di CSS -->
                    ...
                    <!-- Kolom Hasil AI: Menggunakan kelas container yang sudah diatur di CSS -->
